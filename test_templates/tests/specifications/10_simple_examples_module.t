...
',
				...
				command_tests => [
						  ...
						  {
						   comment => "Due to the given timeout value, this test waits for a maximum of one second before it would error out.
The default timeout value is two seconds.",
       ...
       comment => "This module provides examples of simple tests, how to disable specific tests and how to flag tests with a hard error.
...
please take a look at the test suite of the Neurospaces Development project tools.",
       ...
       name => '10_simple_examples_module.t',
      };
